...
DEPLOYMENT_NAME = "energy-forecast-deployment"
...
model = ml_client.models.get("conformal-energy-forecaster", label="latest")
...
if not endpoint_exists:
    ...
    endpoint = BatchEndpoint(
        name=ENDPOINT_NAME,
        description="Energy demand forecasting with conformal prediction intervals",
    )
...
env = ml_client.environments.get("energy-forecast-env", label="latest")
...
# Set as default deployment — re-fetch endpoint to get current state
